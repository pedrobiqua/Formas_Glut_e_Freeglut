...
Cubo::Cubo(int idC, float ppcx, float ppcy, float ppcz, float aa)
{
	...
	f1[0][0] = -a / 2; f1[0][1] = a / 2; f1[0][2] = a / 2;        //A
	f1[1][0] = -a / 2; f1[1][1] = -a / 2; f1[1][2] = a / 2;        //B
	f1[2][0] = a / 2; f1[2][1] = a / 2; f1[2][2] = a / 2;        //C
	f1[3][0] = a / 2; f1[3][1] = -a / 2; f1[3][2] = a / 2;        //D    

	f2[0][0] = a / 2; f2[0][1] = a / 2; f2[0][2] = a / 2;        //C
	f2[1][0] = a / 2; f2[1][1] = -a / 2; f2[1][2] = a / 2;        //D
	f2[2][0] = a / 2; f2[2][1] = a / 2; f2[2][2] = -a / 2;        //E
	f2[3][0] = a / 2; f2[3][1] = -a / 2; f2[3][2] = -a / 2;        //F

	f3[0][0] = a / 2; f3[0][1] = a / 2; f3[0][2] = -a / 2;        //E
	f3[1][0] = a / 2; f3[1][1] = -a / 2; f3[1][2] = -a / 2;        //F
	f3[2][0] = -a / 2; f3[2][1] = a / 2; f3[2][2] = -a / 2;        //G
	f3[3][0] = -a / 2; f3[3][1] = -a / 2; f3[3][2] = -a / 2;    //H

	f4[0][0] = -a / 2; f4[0][1] = a / 2; f4[0][2] = -a / 2;        //G
	f4[1][0] = -a / 2; f4[1][1] = -a / 2; f4[1][2] = -a / 2;    //H
	f4[2][0] = -a / 2; f4[2][1] = a / 2; f4[2][2] = a / 2;        //A
	f4[3][0] = -a / 2; f4[3][1] = -a / 2; f4[3][2] = a / 2;        //B

	f5[0][0] = -a / 2; f5[0][1] = a / 2; f5[0][2] = -a / 2;        //G
	f5[1][0] = -a / 2; f5[1][1] = a / 2; f5[1][2] = a / 2;        //A
	f5[2][0] = a / 2; f5[2][1] = a / 2; f5[2][2] = -a / 2;        //E
	f5[3][0] = a / 2; f5[3][1] = a / 2; f5[3][2] = a / 2;        //C

	f6[0][0] = a / 2; f6[0][1] = -a / 2; f6[0][2] = -a / 2;        //F
	f6[1][0] = a / 2; f6[1][1] = -a / 2; f6[1][2] = a / 2;        //D
	f6[2][0] = -a / 2; f6[2][1] = -a / 2; f6[2][2] = -a / 2;    //H
	f6[3][0] = -a / 2; f6[3][1] = -a / 2; f6[3][2] = a / 2;        //B
}
